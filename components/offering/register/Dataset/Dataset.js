...
export default function Dataset(props) {
    ...
    return (<>
        <Form.Group controlId={eventKey + 'title'}>
            ...
            <Form.Control type="text" placeholder="Title" name={eventKey + 'title'} />
        </Form.Group>

        <Form.Group controlId={eventKey + 'keyword'}>
            <Form.Label>Keyword</Form.Label>
            <Form.Control type="text" placeholder="Keyword" name={eventKey + 'keyword'} />
        </Form.Group>
        ...
        <Row>
            <Col>
                <Form.Group controlId={eventKey + 'dataset'}>
                    ...
                    <Form.Control placeholder="Dataset" name={eventKey + 'dataset'} />
                </Form.Group>
            </Col>
            <Col>
                <Form.Group controlId={eventKey + 'issued'}>
                    <Form.Label>Issued</Form.Label>
                    <Form.Control type="date" placeholder="Issued" name={eventKey + 'issued'} />
                </Form.Group>
            </Col>
            <Col>
                <Form.Group controlId={eventKey + 'modified'}>
                    <Form.Label>Modified</Form.Label>
                    <Form.Control type="date" placeholder="Modified" name={eventKey + 'modified'} />
                </Form.Group>
            </Col>
        </Row>
        ...
        <Row>
            <Col>
                <Form.Group controlId={eventKey + 'language'}>
                    ...
                    <Form.Control type="text" placeholder="Language" name={eventKey + 'language'} />
                </Form.Group>
            </Col>
            <Col>
                <Form.Group controlId={eventKey + 'temporal'}>
                    <Form.Label>Temporal</Form.Label>
                    <Form.Control type="text" placeholder="Temporal" name={eventKey + 'temporal'}
                    />
                </Form.Group>
            </Col>
            <Col>
        ...
        <Row>
            <Col>
                <Form.Group controlId={eventKey + 'spatial'}>
                    ...
                    <Form.Control type="text" placeholder="Spatial" name={eventKey + 'spatial'} />
                </Form.Group>
            </Col>
            <Col>
        ...
        <Form.Group controlId={eventKey + 'theme'}>
            ...
            <Form.Control type="text" placeholder="Theme" name={eventKey + 'theme'} />
        </Form.Group>
