import { arrayField, dateField, citer, setBooleanValue, setIntegerValue, setObjValue, setFloatValue } from '/lib/utils';
...
function getDistribution(fd, datasetEK) {
    ...
    return citer(distributionC, (item, idx) => {
        ...
        if (fd.get(distributionEK + 'title')) {
...
function getDatasetInformation(fd, datasetEK) {
    ...
    return citer(datasetInformationC, (item, idx) => {
        ...
        if (fd.get(informationEK + 'cppType')) {
            let obj = {};
